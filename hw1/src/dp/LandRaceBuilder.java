...
/**
 * Generating LandRace
 * creating new Land arena size 1000 and with 10 Racer Prototypes
 */
public class LandRaceBuilder implements RaceBuilder {
    private ArenaFactory FactoryArena =new ArenaFactory();
    private Race race;
    private int num=10;
    private ArrayList<Racer> newActiveRacers;
    //constructor
    public LandRaceBuilder(){
    ...
    public void BuildRacersList() throws RacerTypeException, RacerLimitException, CloneNotSupportedException {
        ...
        Car careacer=new Car("Prototype",250,20, EnumContainer.Color.BLACK,4);
        this.newActiveRacers.add(careacer);
        for(int i=0;i<this.num-1;i++)
        {
            ...
            Racer copy = (Racer) careacer.clone();
